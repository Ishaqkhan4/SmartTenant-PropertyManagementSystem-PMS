...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::select('applicable_packages[]',$packages,explode(',',$coupon->applicable_packages),array('class'=>'form-control hidesearch basic-select','multiple'))); ?>
...
<?php /**PATH C:\xampp\htdocs\property\resources\views/coupon/edit.blade.php ENDPATH**/ ?>